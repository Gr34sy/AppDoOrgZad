...
Komponent \texttt{PinEntityButton} obsługuje dwa przeciwne stany tego samego mechanizmu. Jeżeli element ma już przypięcie, wysyłane jest żądanie \texttt{DELETE}; w przeciwnym razie komponent tworzy nowe przypięcie za pomocą żądania \texttt{POST}. Po zakończeniu operacji aktualizowany jest lokalny identyfikator przypięcia, co pozwala natychmiast zmienić wygląd przycisku.
