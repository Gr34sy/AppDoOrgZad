...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/frontend/1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/frontend/2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/frontend/3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/frontend/4.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/frontend/Rozbudowa 1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{../screenshots/frontend/Rozbudowa 2 a.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{../screenshots/frontend/Rozbudowa 2 b.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/Rozbudowa 3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/Rozbudowa 4.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/backend/4.png}
  \caption{Fragment kodu przedstawiający konfigurację autoryzacji w Auth.js.}
  \label{fig:backend-auth-options}
\end{figure}

Konfiguracja ``\texttt{authOptions}'' stanowi centralny punkt mechanizmu autoryzacji. W tym miejscu wskazano adapter MongoDB, strategię sesji, stronę logowania oraz listę aktywnych dostawców OAuth. Callback ``\texttt{session}'' dopisuje identyfikator użytkownika do obiektu sesji, dzięki czemu pozostałe endpointy mogą korzystać z jednej funkcji pobierającej właściciela danych.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/testy/Testy 1 .png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/testy/Testy 2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{../screenshots/testy/Testy 3.png}
