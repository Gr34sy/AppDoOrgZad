...
Rozdział szósty prezentuje projekt interfejsu użytkownika oraz scenariusze przypadków użycia. Opisano w nim sposób korzystania z głównych funkcji systemu, takich jak obsługa konta użytkownika, praca z notatkami, checklistami, zadaniami i projektami oraz wykorzystanie widoku tablicowego.
...
Najważniejszym przykładem jest tutaj React\footnote{\emph{React the library for web and native interfaces}, \url{https://react.dev} (dostęp: 28.01.2026).}, czyli biblioteka języka JavaScript.
...
TailwindCSS\footnote{\emph{Strona Tailwindcss}, \url{https://tailwindcss.com} (dostęp: 28.01.2026).} jest frameworkiem służącym do stylowania interfejsów użytkownika za pomocą gotowych klas CSS, używanych bezpośrednio
...
Istotną zaletą Nexta jest również integracja z biblioteką \href{https://authjs.dev}{Auth.js}. Pozwala to implementować zabezpieczenia zarówno po stronie klienta - jak warunkowe renderowanie widoków, oraz po stronie serwera - ochrona endpointów API, czy walidacja sesji
...
Albiorix Technology, \emph{Web application architecture layers}, \url{https://www.albiorixtech.com/wp-content/uploads/2025/12/web-application-architecture-layers.jpg} (dostęp: 03.02.2026).

Asana, Inc., \emph{Asana}, \url{https://asana.com} (dostęp: 17.07.2026).

Atlassian, \emph{Trello}, \url{https://trello.com} (dostęp: 17.07.2026).

Auth.js, \emph{Auth.js}, \url{https://authjs.dev} (dostęp: 17.07.2026).

Canva, \emph{Creating a data flow diagram: How-tos, templates, and tips}, \url{https://www.canva.com/online-whiteboard/data-flow-diagrams/} (dostęp: 03.02.2026).

ClickUp, \emph{ClickUp}, \url{https://clickup.com} (dostęp: 17.07.2026).

Dean J., \emph{Web programming with HTML, CSS, and JavaScript}, Burlington 2017.

\emph{Frontend vs Backend}, \url{https://d1zruf9db62p8s.cloudfront.net/2025/08/Frontend-vs-Backend.webp} (dostęp: 02.02.2026).
...
MongoDB, Inc., \emph{Welcome to the MongoDB docs}, \url{https://www.mongodb.com/docs/} (dostęp: 02.02.2026).
...
React, \emph{React: The library for web and native interfaces}, \url{https://react.dev} (dostęp: 28.01.2026).

Tailwind Labs, \emph{Tailwind CSS}, \url{https://tailwindcss.com} (dostęp: 28.01.2026).

Vercel, \emph{Next.js Docs}, \url{https://nextjs.org/docs} (dostęp: 29.01.2026).
