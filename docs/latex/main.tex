...
Inspiracją dla tematu są popularne aplikacje do zarządzania projektami, kładące duży nacisk na organizację pracy zespołowej. Narzędzia takie jak Trello\footnote{Atlassian, \emph{Trello}, \url{https://trello.com} (dostęp: 17.07.2026).}, Asana\footnote{Asana, Inc., \emph{Asana}, \url{https://asana.com} (dostęp: 17.07.2026).} czy ClickUp\footnote{ClickUp, \emph{ClickUp}, \url{https://clickup.com} (dostęp: 17.07.2026).} dostarczają szeroką gamę funkcji, umożliwiających organizację zadań, jednak wiele z nich jest niepotrzebne użytkownikowi indywidualnemu. Z kolei nadmiar zbędnych funkcji może utrudniać użytkownikowi korzystanie z aplikacji. Dlatego też w projekcie zdecydowano się na zaadaptowanie najważniejszych funkcji z wcześniej wymienionych aplikacji, dla potrzeb użytkowników indywidualnych. Tak więc, w prezentowanym projekcie znajdują się uproszczone rozwiązania stosowane w komercyjnych aplikacjach tego typu.
...
\item {\RaggedRight Albiorix Technology, \emph{Web application architecture layers}, \url{https://www.albiorixtech.com/wp-content/uploads/2025/12/web-application-architecture-layers.jpg} (dostęp: 03.02.2026).\par}

\item {\RaggedRight Asana, Inc., \emph{Asana}, \url{https://asana.com} (dostęp: 17.07.2026).\par}

\item {\RaggedRight Atlassian, \emph{Trello}, \url{https://trello.com} (dostęp: 17.07.2026).\par}

\item {\RaggedRight Auth.js, \emph{Auth.js}, \url{https://authjs.dev} (dostęp: 17.07.2026).\par}

\item {\RaggedRight Canva, \emph{Creating a data flow diagram: How-tos, templates, and tips}, \url{https://www.canva.com/online-whiteboard/data-flow-diagrams/} (dostęp: 03.02.2026).\par}

\item {\RaggedRight ClickUp, \emph{ClickUp}, \url{https://clickup.com} (dostęp: 17.07.2026).\par}

\item Dean J., \emph{Web programming with HTML, CSS, and JavaScript}, Burlington 2017.

\item {\RaggedRight \emph{Frontend vs Backend}, \url{https://d1zruf9db62p8s.cloudfront.net/2025/08/Frontend-vs-Backend.webp} (dostęp: 02.02.2026).\par}

\item {\RaggedRight Microsoft, \emph{TypeScript Documentation}, \url{https://www.typescriptlang.org/docs/} (dostęp: 25.07.2026).\par}

\item {\RaggedRight MongoDB, Inc., \emph{Welcome to the MongoDB docs}, \url{https://www.mongodb.com/docs/} (dostęp: 02.02.2026).\par}

\item {\RaggedRight Oracle, \emph{MySQL Documentation}, \url{https://dev.mysql.com/doc/} (dostęp: 25.07.2026).\par}

\item {\RaggedRight React, \emph{React: The library for web and native interfaces}, \url{https://react.dev} (dostęp: 28.01.2026).\par}
...
\item {\RaggedRight Tailwind Labs, \emph{Tailwind CSS}, \url{https://tailwindcss.com} (dostęp: 28.01.2026).\par}

\item {\RaggedRight Vercel, \emph{Next.js Docs}, \url{https://nextjs.org/docs} (dostęp: 29.01.2026).\par}
